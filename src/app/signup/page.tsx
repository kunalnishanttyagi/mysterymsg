      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            ...
            <Input id="firstname" name="firstname" placeholder="Nishant" type="firstname" onChange={handlechange} />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Last name</Label>
            <Input id="lastname" name="lastname" placeholder="Tyagi" type="lastname" onChange={handlechange} />
          </LabelInputContainer>
        </div>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Email Address</Label>
          <Input id="email" name="email" placeholder="xyz@fc.com" type="email" onChange={handlechange} />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Username</Label>
          <Input id="username" name="username" placeholder="nishant1" type="username" onChange={handlechange} />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
